...
// public class MeltingHurricane extends AbstractDynamicCard
public class MeltingHurricane extends AbstractDynamicCard {
    ...
    public MeltingHurricane() { // public MeltingHurricane() - This one and the one right under the imports are the most important ones, don't forget them
