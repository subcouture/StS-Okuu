...
import utsuhoReiuji.patches.AbstractCardEnum;
...
@SpireInitializer
public class OkuuMod implements
        EditCardsSubscriber,
    ...
    private static final String ATTACK_DEFAULT_GRAY = "utsuhoReiujiResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "utsuhoReiujiResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "utsuhoReiujiResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "utsuhoReiujiResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "utsuhoReiujiResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "utsuhoReiujiResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "utsuhoReiujiResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "utsuhoReiujiResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "utsuhoReiujiResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String UTSUHO_REIUJI_BUTTON = "utsuhoReiujiResources/images/charSelect/OkuuCharacterButton.png";
    ...
    public static final String THE_DEFAULT_SKELETON_ATLAS = "utsuhoReiujiResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "utsuhoReiujiResources/images/char/defaultCharacter/skeleton.json";
    ...
    public OkuuMod() {
      ...
      */
        ...
        // Because your mod ID isn't the default. Your
        // cards (and everything else) should have Your mod id. Not mine.
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = OkuuMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = OkuuMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = OkuuMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        OkuuMod defaultmod = new OkuuMod();
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(CardStrings.class,
                getModID() + "Resources/localization/eng/OkuuMod-Card-Strings.json");
        
        // PowerStrings
        BaseMod.loadCustomStringsFile(PowerStrings.class,
                getModID() + "Resources/localization/eng/OkuuMod-Power-Strings.json");
        
        // RelicStrings
        BaseMod.loadCustomStringsFile(RelicStrings.class,
                getModID() + "Resources/localization/eng/OkuuMod-Relic-Strings.json");
        
        // Event Strings
        BaseMod.loadCustomStringsFile(EventStrings.class,
                getModID() + "Resources/localization/eng/OkuuMod-Event-Strings.json");
        
        // PotionStrings
        BaseMod.loadCustomStringsFile(PotionStrings.class,
                getModID() + "Resources/localization/eng/OkuuMod-Potion-Strings.json");
        
        // CharacterStrings
        BaseMod.loadCustomStringsFile(CharacterStrings.class,
                getModID() + "Resources/localization/eng/OkuuMod-Character-Strings.json");
    ...
    public void receiveEditKeywords() {
        ...
        Gson gson = new Gson();
        String json = Gdx.files.internal(getModID() + "Resources/localization/eng/OkuuMod-Keyword-Strings.json").readString(String.valueOf(StandardCharsets.UTF_8));
...
//                                         .&%####&&&%%%%&/%%&,//&%%&&#################*######%%%%#######%%%%%%%%%%%%&%%&%%##%%%%&....
//                                           &%##%%%%%##/%&&&&**///%%%%&&##################%%%%%%%######%%%%%/%%%%%%&&%%&%%%%%%%&......
// @miowool for the original art for this little ascii banner.
