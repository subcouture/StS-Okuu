...
import OkuuMod.events.IdentityCrisisEvent;
import OkuuMod.potions.PlaceholderPotion;
import OkuuMod.relics.BottledPlaceholderRelic;
import OkuuMod.relics.DefaultClickableRelic;
import OkuuMod.relics.PlaceholderRelic;
import OkuuMod.relics.PlaceholderRelic2;
import utsuhoReiuji_old.util.IDCheckDontTouchPls;
import utsuhoReiuji_old.util.TextureLoader;
import OkuuMod.variables.DefaultCustomVariable;
import OkuuMod.variables.SecondMagicNumber;
...
public class OkuuMod_Old implements
        EditCardsSubscriber,
    ...
    public static final Logger logger = LogManager.getLogger(OkuuMod_Old.class.getName());
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = OkuuMod_Old.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = OkuuMod_Old.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = OkuuMod_Old.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        OkuuMod_Old defaultmod = new OkuuMod_Old();
