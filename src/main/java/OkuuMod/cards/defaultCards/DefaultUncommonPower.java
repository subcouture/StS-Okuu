package OkuuMod.cards.defaultCards;
...
import OkuuMod.actions.UncommonPowerAction;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = OkuuMod_Old.makeID(DefaultUncommonPower.class.getSimpleName());
