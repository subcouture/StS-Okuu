...
import OkuuMod.OkuuMod;
import OkuuMod.util.CardStats;
import OkuuMod.util.TriFunction;
...
import static OkuuMod.util.GeneralUtils.removePrefix;
import static OkuuMod.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return OkuuMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    OkuuMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
