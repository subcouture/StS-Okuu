...
import OkuuMod.patches.relics.BottledPlaceholderField;
import utsuhoReiuji_old.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static utsuhoReiuji_old.OkuuMod_Old.makeRelicOutlinePath;
import static utsuhoReiuji_old.OkuuMod_Old.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = OkuuMod_Old.makeID("BottledPlaceholderRelic");
